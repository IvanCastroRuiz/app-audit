...
//                System.out.println("  ******   *** * ** * *");
//                System.out.println(" "+Rs.getInt("Cuenta"));
//                System.out.println(" "+Rs.getInt("Fecha"));
//                System.out.println(" "+Rs.getDouble("Numdoc"));
//                System.out.println(" "+Rs.getInt("Credit"));
//                System.out.println(" "+Rs.getInt("Debito"));
//                System.out.println(" "+Rs.getInt("Periodo"));
                
                DetBancoInsert.add(Rs.getInt("Cuenta"));
                DetBancoInsert.add(Rs.getInt("Fecha"));
                DetBancoInsert.add(Rs.getDouble("Numdoc"));
                DetBancoInsert.add(Rs.getDouble("Credit"));
                DetBancoInsert.add(Rs.getDouble("Debito"));
