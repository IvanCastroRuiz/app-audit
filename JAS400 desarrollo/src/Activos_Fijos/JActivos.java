 ...
 * @author GACA1186
 */
public class JActivos extends javax.swing.JFrame {
    ...
    public JActivos(JConection JBase_Datos3, Connection Cn2) {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Nro Placa (Numero/'Todas')");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        this.getInformacion_Activo(this.jTextField2.getText().trim());
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
       ...
       public void getInformacion_Activo(String Placa){
        try {
            String Str_Sql="";
            if(!Placa.equals("Todas")){
            Str_Sql ="SELECT ESTACT, T03.desubi, T02.DESCOS , T01.*                        \n" +
                             "         from actlib.mactivo  as T01 left join      \n" +
                            "actlib.MCCOSTO as T02 on T01.CCOSTO=T02.CODCOS      \n" +
                            "AND T01.DIVISI = T02.CODDIV                         \n" +
                            "left join actlib.MUBICAC as T03 on                  \n" +
                            "T01.CCOSTO=T03.CODCOS and  T01.UBICAC  = T03.CODUBI and "
                            + "T01.DIVISI  = T03.CODDIV "
                            + " WHERE PLAACT="+Placa ;
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JActivos.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new JActivos(null,null).setVisible(true);
            }
        });
    }
