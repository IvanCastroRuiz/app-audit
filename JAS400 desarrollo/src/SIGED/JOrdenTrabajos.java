 ...
 * @author GACA1186
 */
public class JOrdenTrabajos extends javax.swing.JFrame {
    ...
    public JOrdenTrabajos(JConection JBase_Datos3, Connection Cn2) {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel11.setText("Fecha Final (aaaammdd)");

        jLabel12.setText("Fecha  (aaaammdd)");
        ...
        jButton12.setIcon(new javax.swing.ImageIcon(getClass().getResource("/export.png"))); // NOI18N
        ...
        jPanel7Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel7Layout.createSequentialGroup()
                ...
                .addGroup(jPanel7Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(jScrollPane7, javax.swing.GroupLayout.PREFERRED_SIZE, 1084, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addGroup(jPanel7Layout.createSequentialGroup()
                        .addGroup(jPanel7Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(jXDatePicker7, javax.swing.GroupLayout.PREFERRED_SIZE, 231, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addGroup(jPanel7Layout.createSequentialGroup()
                                .addGap(34, 34, 34)
                        ...
                        .addGroup(jPanel7Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(jPanel7Layout.createSequentialGroup()
                                .addComponent(jXDatePicker8, javax.swing.GroupLayout.PREFERRED_SIZE, 199, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addGap(78, 78, 78)
        ...
        jTabbedPane1.addTab("Pendiente", jPanel7);
    ...
    private void jButton11ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton11ActionPerformed
        // TODO add your handling code here:
        String Fec_1= d.format(jXDatePicker7.getDate()).toString().trim();
        String Fec_2= d.format(jXDatePicker8.getDate()).toString().trim();
        getInformacion_Orden_Trabajo_Aire(Fec_1, Fec_2);
    ...
    private void jButton12ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton12ActionPerformed
        // TODO add your handling code here:
                // TODO add your handling code here:
        JExport  JFile = new JExport ();
        JFile.setTable(jTable7);
        JFile.setVisible(true);
    }//GEN-LAST:event_jButton12ActionPerformed
    public void getInformacion_Orden_Trabajo_Aire(String FechaInicial , String FechaFinal){
           try {
             String Str_Sql= "select t1.*, t2.*, t4.*, t5.*,t3.*                          \n" +
                            "from sgdatos.TORTC  as t1 , sgdatos.TORTD as t2              \n" +
                            ", sgdatos.GCPROVF as t3 , sgdatos.TPROY as t4 ,              \n" +
                            " CONDAT2006.centro as t5                                     \n" +
                            " where  t1.TOCNUM=t2.TOCNUM and                              \n" +
                            "       t1.TOCPVE=t3.CODPVE  and  t1.TUNCVE=t4.TPYCVE and     \n" +
                            "        CODCEN=t1.TUNCVE                                     \n" +
                            " and t1.TOCEST in('D','A') and NUMIVA= 0                     \n" +
                            " and TOCFEC between  "+FechaInicial+" and  "+FechaFinal;
             ResultSet rs = JBase_Datos.SQL_QRY(this.Cn,Str_Sql);
             this.setTable(this.jTable7 ,rs);
    ...
    public void getInformacion(String FechaInicial , String FechaFinal){
        try {
             String Str_Sql =   "SELECT T04.ORDPAG, T05.NIT, T05.DESPVE, T07.DSCGCN, T01.* ,T06.* , T02.*, T03.*, T04.*, T05.*  FROM SGDATOS.TORTC AS T01  , SGDATOS.GCFRASF AS T02  \n" +
                                ", SGDATOS.GCCOPAF AS T03 , SGDATOS.GCDCTOF AS T04 ,           \n" +
                                " SGDATOS.GCPROVF AS T05 , SGDATOS.TORTD AS T06, SGDATOS.CGCNCOF AS T07                \n" +
                                "WHERE T01.TIPFAC=T02.TIPFAC AND T01.NUMIVA=T02.NUMIVA   AND T01.CODCCO=T07.CODCCO      \n" +
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JOrdenTrabajos.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new JOrdenTrabajos(null,null).setVisible(true);
            }
        });
    }
