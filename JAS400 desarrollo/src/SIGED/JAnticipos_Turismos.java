 ...
 * @author GACA1186
 */
public class JAnticipos_Turismos extends javax.swing.JFrame {
    ...
    public JAnticipos_Turismos(JConection JBase_Datos3, Connection Cn2) {
        initComponents();
    ...
    private void initComponents() {
        ...
        setTitle("Consulta General Anticipos a Proveedores Turisticos");
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
       ...
       public void getInformacion(){
        try {
             String Str_Sql =   "select T01.CODPVE , T02.DESPVE , T01.*                       \n" +
                                "         from sgdatos.GCFRASF as T01, sgdatos.GCPROVF as T02 \n" +
                                "WHERE T01.CODPVE=T02.CODPVE                                  \n" +
                                "AND CONCCP = 'ANC'  AND ESTFRA = ''                           ";
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JAnticipos_Turismos.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new JAnticipos_Turismos(null,null).setVisible(true);
            }
        });
    }
