...
public class JPeriodos extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if(this.jCPeriodo.getSelectedItem().toString().trim().equals("")){
            ...
            if(Tipo==1){
                JDistribucion FrmDistribucion = new JDistribucion (this.JBase_Datos, this.Cn, this.Usuario,this.jCPeriodo.getSelectedItem().toString().trim());
                FrmDistribucion.setVisible(true);
            }
            if(Tipo==2){
                JInversiones FrmInversiones = new JInversiones(this.JBase_Datos, this.Cn, this.Usuario, this.jCPeriodo.getSelectedItem().toString().trim());
                FrmInversiones.setVisible(true);
            }
            this.dispose();
        }
