 ...
 * @author GACA1186
 */
public class JBoletas_Recreacion extends javax.swing.JFrame {
    ...
    public JBoletas_Recreacion(JConection JBase_Datos3, Connection Cn2) {
    ...
    private void initComponents() {
        ...
        setTitle("Venta de Boletas Centros Recreacionales");
        ...
        jTabbedPane1.addTab("Boletas", jPanel1);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JBoletas_Recreacion.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new JBoletas_Recreacion(null, null).setVisible(true);
            }
        });
    }
